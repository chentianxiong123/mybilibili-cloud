...
public class MQConstants {
    ...
    public static final String TOPIC_VIDEO_PROCESS = "video-process-topic";

    public static final String TOPIC_VIDEO_PUBLISH = "video-publish-topic";

    public static final String TOPIC_SEARCH_INDEX = "search-index-topic";
    ...
    public static final String TOPIC_STUDIO_EXPORT = "studio-export-topic";
    public static final String TOPIC_MANUSCRIPT_INDEX = "manuscript-index-topic";
    ...
    public static final String GROUP_STUDIO_EXPORT = "studio-export-group";
