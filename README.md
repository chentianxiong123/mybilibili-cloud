...
仿B站（哔哩哔哩）微服务架构视频平台，基于 Spring Cloud + Vue 3 构建，涵盖视频投稿、弹幕、评论、私信、动态、搜索、AI 字幕/摘要等核心功能。
...
```
        ...
        │          │          │          │          │
   ┌────┴────┐ ┌───┴───┐ ┌───┴───┐ ┌───┴───┐ ┌───┴────┐
   │  User   │ │ Video │ │Comment│ │Danmaku│ │Search  │
...
| mybilibili-ai | - | 视频转码(HLS)、AI 字幕生成、AI 摘要、SSE 进度推送 |
