...
export function Hotkeys(props: ISettingsProps) {
  ...
  function openMarkersInfoPage() {
    remote.shell.openExternal(
      'https://mybilibili.com/content-hub/post/bookmarking-for-mybilibili-desktop',
    );
  }
        ...
        <>
          {getOS() === OS.Mac && (
            <div style={{ display: 'flex', alignItems: 'center' }}>
              ...
              <Tooltip
                title={$t(
                  'To use hotkeys on Mac, go to System Settings > Security > Accessibility and toggle on for mybilibili Live Desktop.',
                )}
                lightShadow
