    ...
    <div className={cx(styles.container, styles.virtualWebcam)}>
      <ObsSettingsSection key="vw-description">
        <div className={styles.description}>
          {$t(
            'Virtual Webcam allows you to display your scenes from mybilibili Live Desktop in video conferencing software. mybilibili Live Desktop will appear as a Webcam that can be selected in most video conferencing apps.',
          )}
        </div>
      </ObsSettingsSection>
