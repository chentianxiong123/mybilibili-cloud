...
export interface ProjectState {
  ...
  updateClipBlendMode: (
    clipId: string,
    blendMode: import("@mybilibili-studio/core").BlendMode,
  ) => boolean;
  ...
  updateClipEmphasisAnimation: (
    clipId: string,
    emphasisAnimation: import("@mybilibili-studio/core").EmphasisAnimation,
  ) => boolean;
  ...
  updateText3D: (
    clipId: string,
    text3d: import("@mybilibili-studio/core").Text3DSettings | undefined,
  ) => TextClip | null;
  ...
  addSubtitle: (subtitle: import("@mybilibili-studio/core").Subtitle) => Promise<void>;
  removeSubtitle: (subtitleId: string) => void;
  updateSubtitle: (
    subtitleId: string,
    updates: Partial<import("@mybilibili-studio/core").Subtitle>,
  ) => void;
  getSubtitle: (
    subtitleId: string,
  ) => import("@mybilibili-studio/core").Subtitle | undefined;
  importSRT: (
    srtContent: string
  ...
  updateMarker: (
    markerId: string,
    updates: Partial<import("@mybilibili-studio/core").Marker>,
  ) => void;
  getMarker: (markerId: string) => import("@mybilibili-studio/core").Marker | undefined;
  getMarkers: () => import("@mybilibili-studio/core").Marker[];
  ...
  updateSVGClip: (
    ...
    updates: {
      ...
      duration?: number;
      transform?: Partial<Transform>;
      entryAnimation?: import("@mybilibili-studio/core").GraphicAnimation;
      exitAnimation?: import("@mybilibili-studio/core").GraphicAnimation;
      colorStyle?: import("@mybilibili-studio/core").SVGColorStyle;
    },
  ) => SVGClip | null;
  ...
  subscribeWithSelector((set, get) => {
    ...
    return {
      ...
      addMarker: (time, label = "Marker", color = "#3b82f6") => {
        const newMarker: import("@mybilibili-studio/core").Marker = {
