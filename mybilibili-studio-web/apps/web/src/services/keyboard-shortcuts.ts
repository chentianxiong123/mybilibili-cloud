...
const PRESETS: ShortcutPreset[] = [
  {
    id: "mybilibili",
    name: "mybilibili 默认",
    description: "mybilibili 剪辑工作室默认快捷键",
    shortcuts: {},
  },
  {
    id: "capcut",
...
class KeyboardShortcutsManager {
  ...
  private activePreset: string = "mybilibili";
