...
import type { ScriptableTemplate, SocialMediaCategory } from "@mybilibili-studio/core";
import { SOCIAL_MEDIA_PRESETS } from "@mybilibili-studio/core";
    ...
    >
      ...
      <div className="p-3 text-left">
        ...
        <div className="flex items-center gap-3 mt-1.5">
          ...
          <div className="flex items-center gap-1.5 text-[11px] text-text-muted">
            <Layers size={11} />
            <span>{template.placeholders.length} 项可编辑</span>
          </div>
        </div>
