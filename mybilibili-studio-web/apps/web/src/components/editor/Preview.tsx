...
import type { MotionPathConfig, GSAPMotionPathPoint } from "@mybilibili-studio/core";
...
export const Preview: React.FC = () => {
  ...
  const loadAudioBuffer = async (
    ...
    try {
      const { getFFmpegFallback } = await import("@mybilibili-studio/core/media");
