...
import AssetsPanelVue from "./AssetsPanel.vue";
...
export const EditorInterface: React.FC = () => {
  ...
  const [copiedKeyframes, setCopiedKeyframes] = React.useState<
    import("@mybilibili-studio/core").Keyframe[]
  >([]);
  ...
  const handleUpdateKeyframe = React.useCallback(
    (
      keyframeId: string,
      updates: Partial<import("@mybilibili-studio/core").Keyframe>,
    ) => {
  ...
  return (
    ...
    >
      <VueAdapter component={ToolbarVue} />
