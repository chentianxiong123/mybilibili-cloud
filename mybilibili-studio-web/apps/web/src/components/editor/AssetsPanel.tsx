...
import type { ShapeType } from "@mybilibili-studio/core";
import { useProjectStore } from "../../stores/project-store";
import { useUIStore } from "../../stores/ui-store";
import type { MediaItem } from "@mybilibili-studio/core";
...
const ASSETS_TABS: ReadonlyArray<{
  ...
  },
  {
    value: "ai",
    label: "AI 生成",
    description: "生成片段、字幕和辅助剪辑内容。",
  },
  {
    value: "recipes",
    label: "方案",
    description: "应用片段级外观、叠加层和文字组合。",
  },
  {
    value: "templates",
    label: "项目模板",
    description: "加载完整项目起始布局和预设。",
  },
] as const;
                      ...
                      (emoji, i) => (
                        <button
                          ...
                          onClick={async () => {
                            ...
                            const { stickerLibrary } = await import("@mybilibili-studio/core");
