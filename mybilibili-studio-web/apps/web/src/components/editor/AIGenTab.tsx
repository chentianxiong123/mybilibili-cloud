...
import { ScrollArea } from "@mybilibili-studio/ui";
    ...
    <ScrollArea className="flex-1 w-full">
      <div className="p-4 space-y-6 min-w-0">
        <div className="text-center pb-2">
          ...
          <h2 className="text-sm font-semibold text-text-primary">AI 辅助工具</h2>
          <p className="text-[11px] text-text-muted mt-1">用智能能力加速剪辑流程</p>
        </div>
