...
const RESOLUTION_OPTIONS: {
  ...
  { value: "720p", label: "720p 高清", desc: "1280×720 - 文件更小" },
  { value: "1080p", label: "1080p 全高清", desc: "1920×1080 - 推荐" },
  { value: "1440p", label: "1440p QHD", desc: "2560×1440 - 高画质" },
  { value: "4k", label: "4K 超清", desc: "3840×2160 - 最高画质" },
];
            ...
            <div className="flex items-start gap-3 p-4 bg-error/10 border border-error/30 rounded-lg">
              ...
              <div>
                ...
                <p className="text-xs text-text-muted mt-1">
                  你的浏览器不支持屏幕录制。请使用 Chrome、Edge 或 Firefox。
                </p>
              </div>
            </div>
          )}
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              ...
              >
                ...
                <span className="text-sm">系统声音</span>
              </button>
