...
import { SpeechToTextEngine } from "@mybilibili-studio/core";
import type {
...
const CAPTION_STYLE_PRESETS = [
  ...
  { id: "modern", name: "现代", description: "干净简洁的样式" },
  { id: "bold", name: "醒目", description: "大号强调文字" },
  { id: "cinematic", name: "电影感", description: "影片字幕风格" },
  { id: "minimal", name: "极简", description: "低调克制的样式" },
];
...
export const AutoCaptionPanel: React.FC = () => {
  ...
  const handleStartTranscription = useCallback(async () => {
    ...
    try {
      ...
      setError(
        err instanceof Error ? err.message : "启动转写失败",
      );
    ...
    return (
      <div className="p-4 space-y-3">
        ...
        <p className="text-[10px] text-text-muted">
          自动字幕需要支持语音识别 API 的 Chrome 或 Edge 浏览器。
        </p>
      </div>
    );
  }
