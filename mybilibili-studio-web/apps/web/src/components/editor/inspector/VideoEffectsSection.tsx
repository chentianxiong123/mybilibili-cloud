...
const EFFECT_TYPES: {
  ...
  { type: "brightness", label: "亮度", category: "基础" },
  { type: "contrast", label: "对比度", category: "基础" },
  { type: "saturation", label: "饱和度", category: "基础" },
  { type: "temperature", label: "色温", category: "颜色" },
  { type: "tint", label: "色调", category: "颜色" },
  { type: "blur", label: "模糊", category: "模糊" },
  { type: "motion-blur", label: "运动模糊", category: "模糊" },
  { type: "radial-blur", label: "径向模糊", category: "模糊" },
  { type: "sharpen", label: "锐化", category: "创意" },
  { type: "vignette", label: "暗角", category: "创意" },
  { type: "grain", label: "胶片颗粒", category: "创意" },
  { type: "shadow", label: "投影", category: "风格化" },
  { type: "glow", label: "发光", category: "风格化" },
  { type: "chromatic-aberration", label: "色差", category: "风格化" },
];
