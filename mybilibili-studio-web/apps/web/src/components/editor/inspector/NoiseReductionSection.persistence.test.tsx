...
import { autoLearnNoiseProfile, type Project } from "@mybilibili-studio/core";
...
vi.mock("@mybilibili-studio/core", async () => {
  const actual = await vi.importActual<typeof import("@mybilibili-studio/core")>("@mybilibili-studio/core");
  return {
    ...actual,
