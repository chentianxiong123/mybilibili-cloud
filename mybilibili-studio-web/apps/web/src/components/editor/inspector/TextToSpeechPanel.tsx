...
import { Slider, Switch } from "@mybilibili-studio/ui";
  ...
  return (
    <div className="space-y-3 w-full min-w-0 max-w-full">
          ...
          {TTS_PROVIDERS.map((p) => {
            ...
            return (
              <button
                ...
                title={isDisabled ? "请先在设置中添加 ElevenLabs 接口密钥" : p.description}
              >
                {p.label}
              </button>
            );
      ...
      <p className="text-[9px] text-text-muted text-center">
        语音服务：{provider === "elevenlabs" ? "ElevenLabs" : "Piper TTS"}
