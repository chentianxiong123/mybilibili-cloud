...
import type { TextStyle, FontWeight } from "@mybilibili-studio/core";
import {
  ColorPicker,
  Select,
  SelectTrigger,
  ...
  return (
    <div className="space-y-4">
      <div className="space-y-2">
        <span className="text-[10px] text-text-secondary">文字内容</span>
        <textarea
          value={text}
      ...
      <div className="flex items-center justify-between">
        <span className="text-[10px] text-text-secondary">文字对齐</span>
        <ToggleButtonGroup
          options={[
