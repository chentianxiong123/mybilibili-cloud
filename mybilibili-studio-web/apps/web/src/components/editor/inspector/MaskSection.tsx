...
import type { Mask, MaskShape } from "@mybilibili-studio/core";
import { boundsPathFromTransform } from "@mybilibili-studio/core";
...
export const MaskSection: React.FC<MaskSectionProps> = ({ clipId }) => {
  ...
  const [maskEngine, setMaskEngine] =
    useState<import("@mybilibili-studio/core").MaskEngine | null>(null);
