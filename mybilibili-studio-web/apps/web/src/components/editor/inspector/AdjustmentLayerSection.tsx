...
import { Slider } from "@mybilibili-studio/ui";
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
} from "@mybilibili-studio/ui/components/popover";
import { useEngineStore } from "../../../stores/engine-store";
import { useProjectStore } from "../../../stores/project-store";
import type { AdjustmentLayer, BlendMode, Effect } from "@mybilibili-studio/core";
...
export const AdjustmentLayerSection: React.FC<AdjustmentLayerSectionProps> = ({
  ...
  const [adjustmentLayerEngine, setAdjustmentLayerEngine] =
    useState<import("@mybilibili-studio/core").AdjustmentLayerEngine | null>(null);
