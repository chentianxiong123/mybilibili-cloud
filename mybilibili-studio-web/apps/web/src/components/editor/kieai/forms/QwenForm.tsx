import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue, Button } from "@mybilibili-studio/ui";
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-1.5">
        <label className="text-xs font-medium text-text-secondary">
          ...
          <span className="ml-2 text-text-muted font-normal">(0 = 尽量保留原图，1 = 大幅重绘)</span>
        </label>
        <input
          type="range"
          min={0}
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div className="space-y-1.5">
          <label className="text-xs font-medium text-text-secondary">加速模式</label>
          <Select
          ...
          >
            <SelectTrigger className="h-8 text-sm"><SelectValue /></SelectTrigger>
            <SelectContent>
              <SelectItem value="none">不加速（质量优先）</SelectItem>
              <SelectItem value="regular">标准</SelectItem>
